...
export const ApartmentsPage = () => {
  ...
  const filteredApartments = apartments
    ...
    .filter(apartment => {
      ...
      if (priceFilter === "budget") return apartment.pricePerNight <= 100;
      if (priceFilter === "mid") return apartment.pricePerNight > 100 && apartment.pricePerNight <= 200;
      if (priceFilter === "luxury") return apartment.pricePerNight > 200;
      return true;
    })
    .sort((a, b) => {
