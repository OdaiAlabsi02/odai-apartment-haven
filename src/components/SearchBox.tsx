...
export const SearchBox = () => {
  ...
  const handleSearch = () => {
    // For now, we'll show an alert since we removed the apartments page
    // Later this can be updated to show search results directly on the home page
    if (!location && !checkIn && !checkOut) {
      alert("Please enter at least a location or dates to search");
      return;
    }
    
    // For now, just show a message - later we can implement search results
  ...
  return (
    <Card className="p-6 bg-white/95 backdrop-blur-sm shadow-2xl border-0 max-w-4xl mx-auto">
